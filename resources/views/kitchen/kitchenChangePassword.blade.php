            ...
            <div class="col-md-9">
                <div class="card card-warning card-outline">
                    <div class="card-body ">
                        ...
                        <form method="POST" action="{{ route('kitchen.changePasswordSave') }}" class="form-horizontal">
                            @csrf
                                ...
                                <spen id="msg">
                                    ...
                                    @elseif($msg=='notMach')
                                        <div class="p-3 mb-2 bg-denger text-white">Your Old Password are not same.</div>
                                    @endif
