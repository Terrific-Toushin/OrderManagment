...
@section('main_section')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0">KOT Order History</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="#">Home</a></li>
                <li class="breadcrumb-item active">KOT Order History</li>
                </ol>
            </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
            ...
            <div class="row">
                <div class="card mx-auto">
                    ...
                    <div class="card-body foodTabcontent">
                        <div class="row">
                            <div id="date" class=" col-mx-5">
                                <form method="get" action="{{ route('operator.orderHistry') }}">
                                    <!-- Date -->
                                    <div class="form-group">
                                        {{-- <label>Date:</label> --}}
                                        <div class="input-group date" id="reservationdate" data-target-input="nearest">
                                            <div class="input-group-text"><i class="fa fa-calendar"></i>Date:</div>
                                            <input type="text" id="reservationdate2" class="form-control datetimepicker-input reservationdate2" name="date" data-target="#reservationdate"/>
