...
<title>NICE Operator | Dashboard</title>
<!-- favicon -->
<link rel="shortcut icon" href="{{ asset('../assets/dist/img/NICELogo.png ') }}" />
...
<!-- NICE Theme style for operator -->
<link rel="stylesheet" href="{{ asset('../assets/dist/css/operator_nice.css') }}">
<!-- Daterange picker -->
